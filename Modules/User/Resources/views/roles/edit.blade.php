                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               id="dashboard_home" name="permissions[]"
                                                               value="dashboard_home" {{ $role->hasPermissionTo('dashboard_home') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="dashboard_home">Access</label>
