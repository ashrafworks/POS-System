                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="product_tax_type" id="product_tax_type">
                                            ...
                                            <option {{ $product->product_tax_type == 1 ? 'selected' : '' }} value="1">
                                                Exclusive</option>
                                            <option {{ $product->product_tax_type == 2 ? 'selected' : '' }} value="2">
                                                Inclusive</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="product_note" id="product_note" rows="4 "
                                    class="form-control">{{ $product->product_note }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        Dropzone.options.documentDropzone = {
            ...
            removedfile: function (file) {
                ...
                // backend request to delete file
                $.ajax({
                    headers: {
                        'X-CSRF-TOKEN': "{{ csrf_token() }}"
                    },
